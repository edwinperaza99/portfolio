...
import CaC_4 from "@/public/CodeAgainstCancer/4.png";
...
export const projects: Project[] = [
	...
	},
	{
		...
		description: (
			<>
				<p className="text-gray-200 leading-relaxed mb-4">
					<strong>RBR Inventory Formatter</strong> is a web application
					developed to enhance efficiency at the circulation desk of Pollak
					Library. This tool processes{" "}
					<code className="bg-gray-800 text-yellow-400 px-1 rounded">.xls</code>{" "}
					files generated by the Alma library system by automatically removing
				...
				<p className="text-gray-200 leading-relaxed">
					...
					technologies like <span className="text-blue-300">Next.js</span>,{" "}
		...
		images: [RBR_1, RBR_2],
		deployUrl: "https://rbr-inventory-formatter.edwinperaza.com",
