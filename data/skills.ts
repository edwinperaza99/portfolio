...
export const skillRegistry: Skill[] = [
	...
	{ id: "nextjs", name: "Next.js", icon: NextJSIcon, color: "45, 212, 191" },
	{
		id: "tailwindcss",
		name: "Tailwind CSS",
	...
	{ id: "express", name: "Express", icon: ExpressIcon, color: "148, 163, 184" },
	{ id: "python", name: "Python", icon: PythonIcon, color: "#3776AB" },
	{ id: "django", name: "Django", icon: DjangoIcon, color: "41, 201, 165" },
	...
	{ id: "github", name: "GitHub", icon: GitHubIcon, color: "220, 196, 252" },
	...
	{ id: "mysql", name: "MySQL", icon: MySQLIcon, color: "77, 140, 181" },
	{ id: "sqlite3", name: "SQLite3", icon: SQLite3Icon, color: "88, 159, 214" },
	{ id: "vue", name: "Vue", icon: VueIcon, color: "76, 201, 176" },
	{ id: "nuxt", name: "Nuxt.js", icon: NuxtIcon, color: "16, 185, 129" },
	{ id: "aws", name: "AWS", icon: AWSIcon, color: "255, 200, 132" },
	...
	{ id: "flask", name: "Flask", icon: FlaskIcon, color: "184, 192, 204" },
];
