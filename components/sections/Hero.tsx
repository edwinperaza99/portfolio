	...
	return (
		<div className="relative overflow-hidden bg-[image:radial-gradient(80%_50%_at_50%_-20%,hsl(206,81.9%,65.3%,0.5),rgba(255,255,255,0))]">
			...
			<section className="container px-4">
				<div className="min-h-screen grid grid-rows-[1fr_auto] gap-6 py-8">
					<MotionDiv
					...
					>
						<div className="space-y-4">
							...
							>
								<MotionSpan variants={nameLine} className="block text-white">
									Edwin
								</MotionSpan>
								<MotionSpan
									variants={nameLine}
									className="block text-teal-200 -translate-y-3 sm:-translate-y-5"
								>
									Peraza
								</MotionSpan>
							</MotionH1>
						...
						>
							Documenting my journey toward software engineering. Each project
							is a step forward and each bug is a lesson learned.
						</MotionP>
						<MotionDiv
					...
					<MotionDiv
						...
						className="flex items-center justify-center md:justify-between gap-3 md:gap-5 text-2xl text-white/60 w-full"
					>
						<MotionSpan
